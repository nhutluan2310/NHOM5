...
('AB0006', 'Similac Neo Sure', 'AB', 'SB', 370, 145000, 'Chứa LCPUFA (axít béo không no, chuỗi dài và nhiều nối đôi - AA & DHA) -Similac Neosure chứa TPAN (tổng toàn bộ Nucleotide) với hàm lượng 72mg/1', '- Giúp cải thiện đáng kể sự phát triển thị giác và não bộ ở trẻ thiếu tháng khi cho trẻ dùng liên tục trong 12 tháng \n- Giúp tăng cường sự phát triển hệ thống miễn dịch của bé nhờ gia tăng hàm lượng', 's_abbott_similac_400.jpg'),
...
INSERT INTO `table1` (`cl1`, `cl2`, `cl3`) VALUES
(1, '[value-2]', '0000-00-00');
...
--
ALTER TABLE `table1`
  MODIFY `cl1` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
