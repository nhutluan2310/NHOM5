...
<body>
    ...
    if (isset($_GET['search'])) {
        $search = $_GET['search'];
        $query = "SELECT * FROM `premiummembership` WHERE name_package like '%$search%' LIMIT $offset, $rowsPerPage";
        $result = mysqli_query($conn, $query);
    } else {
        $query = "SELECT * FROM `premiummembership` LIMIT $offset, $rowsPerPage";
        $result = mysqli_query($conn, $query);
    }
        ...
        <div class="quixnav">
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow" href="manager-premium.php" active aria-expanded="false"><i class="icon icon-single-04"></i><span class="nav-text">Packages</span></a>
                    </li>
                ...
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-start mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="admin/manager-user.php">Package</a></li>
                        </ol>
                    </div>
                </div>
                <!-- row -->
                                        ...
                                        <tbody>
                                            ...
                                            if ($numRows <> 0) {
                                                ...
                                                while ($rows = mysqli_fetch_array($result)) {
                                                    ...
                                                    echo "<tr>";
                                                    echo "<td>" . $rows['premium_id'] . "</td>";
                                                    echo "<td>" . $rows['name_package'] . "</td>";
                                                    echo "<td>" . $rows['benifit'] . "</td>";
                                                    echo "<td>" . $rows['cost'] . "</td>";
                                                    echo "<td>";
                                                    echo "<a href='edit-premium.php?package_id=" . $rows['premium_id'] . "'>Edit</a>";
                                                    echo "&nbsp;|&nbsp;";
                                                    echo "<a href='delete-premium.php?package_id=" . $rows['premium_id'] . "'>Delete</a>";
                                                    echo "</td>";
                                                    echo "</tr>";
                                                }
                                            ?>
